...
const ProfileText = ({ visible, titleId }) => (
  <Fragment>
    ...
    <Text className={styles.description} data-visible={visible} size="l" as="p">
      ...
      <Link href="https://www.gigafro.com">Gigafro</Link>. My fields include Software developement, DevOps(AWS,Azure,VMware cloud,oracle & cloudflare), hardware enthusiast, security research, cinematography & 3d visual effects. Being comfortable with code allows me to rapidly
